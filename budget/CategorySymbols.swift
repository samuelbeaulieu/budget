...
struct CategorySymbols {
    ...
    static var objectsTools: [String] = [
        "pencil",
        "pencil.circle",
        "pencil.circle.fill",
        "pencil.slash",
    ...
    static var connectivity: [String] = [
        "externaldrive.connected.to.line.below",
        "externaldrive.connected.to.line.below.fill",
        "personalhotspot",
        "personalhotspot.circle",
    ...
    static var transportation: [String] = [
        "airplane",
        "airplane.circle",
    ...
    static var textFormatting: [String] = [
        "signature",
        "paragraphsign",
        "list.dash",
        "list.bullet",
